...
declare const GetDomainNamesCommand_base: {
    new (input: GetDomainNamesCommandInput): import("@smithy/core/client").CommandImpl<GetDomainNamesCommandInput, GetDomainNamesCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetDomainNamesCommandInput]): import("@smithy/core/client").CommandImpl<GetDomainNamesCommandInput, GetDomainNamesCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
