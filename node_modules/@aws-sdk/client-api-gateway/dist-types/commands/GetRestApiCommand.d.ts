...
declare const GetRestApiCommand_base: {
    new (input: GetRestApiCommandInput): import("@smithy/core/client").CommandImpl<GetRestApiCommandInput, GetRestApiCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetRestApiCommandInput): import("@smithy/core/client").CommandImpl<GetRestApiCommandInput, GetRestApiCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
