...
declare const UpdateDomainNameCommand_base: {
    new (input: UpdateDomainNameCommandInput): import("@smithy/core/client").CommandImpl<UpdateDomainNameCommandInput, UpdateDomainNameCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateDomainNameCommandInput): import("@smithy/core/client").CommandImpl<UpdateDomainNameCommandInput, UpdateDomainNameCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
