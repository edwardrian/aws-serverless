...
declare const GetRestApisCommand_base: {
    new (input: GetRestApisCommandInput): import("@smithy/core/client").CommandImpl<GetRestApisCommandInput, GetRestApisCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetRestApisCommandInput]): import("@smithy/core/client").CommandImpl<GetRestApisCommandInput, GetRestApisCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
