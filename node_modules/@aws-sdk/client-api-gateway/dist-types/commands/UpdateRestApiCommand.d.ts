...
declare const UpdateRestApiCommand_base: {
    new (input: UpdateRestApiCommandInput): import("@smithy/core/client").CommandImpl<UpdateRestApiCommandInput, UpdateRestApiCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateRestApiCommandInput): import("@smithy/core/client").CommandImpl<UpdateRestApiCommandInput, UpdateRestApiCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
