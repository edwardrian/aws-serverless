...
declare const CreateDomainNameCommand_base: {
    new (input: CreateDomainNameCommandInput): import("@smithy/core/client").CommandImpl<CreateDomainNameCommandInput, CreateDomainNameCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateDomainNameCommandInput): import("@smithy/core/client").CommandImpl<CreateDomainNameCommandInput, CreateDomainNameCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
