...
declare const GetDomainNameCommand_base: {
    new (input: GetDomainNameCommandInput): import("@smithy/core/client").CommandImpl<GetDomainNameCommandInput, GetDomainNameCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetDomainNameCommandInput): import("@smithy/core/client").CommandImpl<GetDomainNameCommandInput, GetDomainNameCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
