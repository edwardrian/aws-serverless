...
declare const CreateRestApiCommand_base: {
    new (input: CreateRestApiCommandInput): import("@smithy/core/client").CommandImpl<CreateRestApiCommandInput, CreateRestApiCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateRestApiCommandInput): import("@smithy/core/client").CommandImpl<CreateRestApiCommandInput, CreateRestApiCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
