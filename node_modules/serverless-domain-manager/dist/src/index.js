    ...
    validateDomainConfigs() {
        this.domains.forEach((domain) => {
            ...
            if (domain.apiType === globals_1.default.apiTypes.http) {
                ...
                if (domain.endpointType === globals_1.default.endpointTypes.edge || domain.endpointType === globals_1.default.endpointTypes.private) {
                    // https://docs.aws.amazon.com/apigateway/latest/developerguide/http-api-vs-rest.html
                    throw Error("'EDGE' or 'PRIVATE' endpointType is not compatible with HTTP APIs\n" +
                        "https://docs.aws.amazon.com/apigateway/latest/developerguide/http-api-vs-rest.html");
                }
            }
