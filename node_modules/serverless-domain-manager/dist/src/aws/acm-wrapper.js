    ...
    getCertArn(domain) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (certificateArn == null) {
                ...
                if (domain.endpointType === globals_1.default.endpointTypes.private) {
                    errorMessage += ` The endpoint type '${globals_1.default.endpointTypes.private}' is used. ` +
                        `Make sure the needed ACM certificate exists in the '${globals_1.default.getRegion()}' region.`;
                }
