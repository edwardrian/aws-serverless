...
class APIGatewayV2Wrapper extends APIGatewayBase {
    ...
    createCustomDomain(domain) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const isPrivateType = domain.endpointType === globals_1.default.endpointTypes.private;
    ...
    getCustomDomain(domain_1) {
        return __awaiter(this, arguments, void 0, function* (domain, silent = true) {
            const domainNameId = yield this.resolvePrivateDomainNameId(domain, silent);
            if (domainNameId === null)
                return;
            // Make API call
            try {
                const domainInfo = yield this.apiGateway.send(new client_apigatewayv2_1.GetDomainNameCommand(Object.assign({ DomainName: domain.givenDomainName }, (domainNameId && { DomainNameId: domainNameId }))));
                return new DomainInfo(domainInfo);
            }
            catch (err) {
    ...
    fetchPrivateDomainNameId(domain) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const items = yield (0, utils_1.getAWSPagedResults)(this.apiGateway, "Items", "NextToken", "NextToken", new client_apigatewayv2_1.GetDomainNamesCommand({}));
                const matchingDomain = items.find((item) => {
                    var _a;
                    return item.DomainName === domain.givenDomainName &&
                        ((_a = item.DomainNameConfigurations) === null || _a === void 0 ? void 0 : _a.some((config) => config.EndpointType === globals_1.default.endpointTypes.private));
                });
                return matchingDomain === null || matchingDomain === void 0 ? void 0 : matchingDomain.DomainNameId;
            }
            catch (err) {
                logging_1.default.logWarning(`V2 - Unable to list domain names to find domainNameId: ${err.message}`);
                return undefined;
            }
        });
    }
    ...
    deleteCustomDomain(domain) {
        return __awaiter(this, void 0, void 0, function* () {
            // Make API call
            try {
                const domainNameId = yield this.getDomainNameIdForPrivateDomain(domain);
                yield this.apiGateway.send(new client_apigatewayv2_1.DeleteDomainNameCommand(Object.assign({ DomainName: domain.givenDomainName }, (domainNameId && { DomainNameId: domainNameId }))));
            }
            catch (err) {
    ...
    createBasePathMapping(domain) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const domainNameId = yield this.getDomainNameIdForPrivateDomain(domain);
                yield this.apiGateway.send(new client_apigatewayv2_1.CreateApiMappingCommand(Object.assign({ ApiId: domain.apiId, ApiMappingKey: domain.basePath, DomainName: domain.givenDomainName, Stage: domain.stage }, (domainNameId && { DomainNameId: domainNameId }))));
    ...
    getBasePathMappings(domain) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const domainNameId = yield this.getDomainNameIdForPrivateDomain(domain);
                const items = yield (0, utils_1.getAWSPagedResults)(this.apiGateway, "Items", "NextToken", "NextToken", new client_apigatewayv2_1.GetApiMappingsCommand(Object.assign({ DomainName: domain.givenDomainName }, (domainNameId && { DomainNameId: domainNameId }))));
    ...
    updateBasePathMapping(domain) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const domainNameId = yield this.getDomainNameIdForPrivateDomain(domain);
                yield this.apiGateway.send(new client_apigatewayv2_1.UpdateApiMappingCommand(Object.assign({ ApiId: domain.apiId, ApiMappingId: domain.apiMapping.apiMappingId, ApiMappingKey: domain.basePath, DomainName: domain.givenDomainName, Stage: domain.stage }, (domainNameId && { DomainNameId: domainNameId }))));
    ...
    deleteBasePathMapping(domain) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const domainNameId = yield this.getDomainNameIdForPrivateDomain(domain);
                yield this.apiGateway.send(new client_apigatewayv2_1.DeleteApiMappingCommand(Object.assign({ ApiMappingId: domain.apiMapping.apiMappingId, DomainName: domain.givenDomainName }, (domainNameId && { DomainNameId: domainNameId }))));
