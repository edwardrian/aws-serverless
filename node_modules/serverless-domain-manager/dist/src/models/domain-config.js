...
class DomainConfig {
    ...
    static _getTLSTruststoreUri(tlsTruststoreUri, endpointType) {
        if (tlsTruststoreUri) {
            if (endpointType === globals_1.default.endpointTypes.edge || endpointType === globals_1.default.endpointTypes.private) {
    ...
    static _getRoute53Params(route53Params, endpointType) {
        ...
        if (routingPolicyToUse !== globals_1.default.routingPolicies.simple && (endpointType === globals_1.default.endpointTypes.edge || endpointType === globals_1.default.endpointTypes.private)) {
            throw new Error(`${routingPolicy} routing is not intended to be used with ${endpointType} endpoints. ` +
